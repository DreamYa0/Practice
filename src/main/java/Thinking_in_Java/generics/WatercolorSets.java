...
import Thinking_in_Java.generics.watercolors.Watercolors;

import java.util.EnumSet;
import java.util.Set;

import static Thinking_in_Java.generics.watercolors.Watercolors.*;
import static Thinking_in_Java.net.mindview.util.Sets.*;
