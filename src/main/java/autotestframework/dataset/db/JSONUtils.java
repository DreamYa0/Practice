package autotestframework.dataset.db;
...
public class JSONUtils {
     ...
     * 将List对象序列化为JSON文本
     */
    protected static <T> String toJSONString(List<T> list) {
     ...
     * @return
     */
    protected static String toJSONString(JSONArray jsonArray) {
        return jsonArray.get(0).toString();
    }
     ...
     * @return
     */
    protected static String toJSONString(JSONObject jsonObject) {
     ...
     * @return
     */
    protected static List toArrayList(Object object) {
     ...
     * @return
     */
    protected static Collection toCollection(Object object) {
        JSONArray jsonArray = JSONArray.fromObject(object);
...
// 返回非实体类型(Map<String,Object>)的List
    protected static List<Map<String, Object>> toList(Object object) {
     ...
     * @return
     */
    protected static <T> List<T> toList(JSONArray jsonArray, Class<T> objectClass) {
     ...
     * @return
     */
    protected static <T> List<T> toList(Object object, Class<T> objectClass) {
        JSONArray jsonArray = JSONArray.fromObject(object);
        return JSONArray.toList(jsonArray, objectClass);
    }
     ...
     * @return
     */
    protected static <T> T toBean(JSONObject jsonObject, Class<T> beanClass) {
     ...
     * @return
     */
    protected static <T> T toBean(Object object, Class<T> beanClass) {
        JSONObject jsonObject = JSONObject.fromObject(object);
        return (T) JSONObject.toBean(jsonObject, beanClass);
    }
     ...
     * @return
     */
    protected static <T, D> T toBean(String jsonString, Class<T> mainClass,
     ...
     * @return
     */
    protected static <T, D1, D2> T toBean(String jsonString, Class<T> mainClass,
     ...
     * @return
     */
    protected static <T, D1, D2, D3> T toBean(String jsonString,
     ...
     * @return
     */
    protected static <T> T toBean(String jsonString, Class<T> mainClass,
     ...
     * @param obj
     */
    protected static void outPutJson(Object obj) {
