...
import thinkinginjava.generics.watercolors.Watercolors;

import java.util.EnumSet;
import java.util.Set;

import static thinkinginjava.generics.watercolors.Watercolors.*;
import static thinkinginjava.net.mindview.util.Sets.*;
